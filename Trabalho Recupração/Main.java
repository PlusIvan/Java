...
public class Main {
	...
	public static void main(String[] args) throws Exception {
		...
		String kjgdjg = crypter.encrypt(atec.getConteudo("DFKJ46765"), "IVANLOL");
		System.out.println(kjgdjg);
		String dlkgmdkfgm = crypter.decrypt(kjgdjg, "IVANLOL");
		System.out.println(dlkgmdkfgm);
